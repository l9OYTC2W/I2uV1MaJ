...
defaults.grid     = 0.4;
defaults.cmdline  = 0;
defaults.printstr = ['print -dpsc2 -painters -append -noui spm5.ps'];
...
% default modality (Upper case)
% Available modalities are 'PET','FMRI' and 'EEG'
...
defaults.preproc.msk      = '';            % Specify the mask file 
